...
df_Q = pd.read_excel('Modulation.xlsx')
print('\n')
...
df_numerology = pd.read_excel('Numerology.xlsx')
print('\n')
print('*****Numerology*****')
print('\n')
...
df_prbfr1 = pd.read_excel('PRB_FR1.xlsx')
df_prbfr2 = pd.read_excel('PRB_FR2.xlsx')
print('\n')
...
df_OH = pd.read_excel('Overhead.xlsx')
print('\n')
